...
public class CompraDTO implements Serializable {
    ...
    public CompraDTO(String origen, String destino, String hrSalida, UsuarioDTO usuario, Double precio, String duracion, CamionDTO camion, List<AsientoBoletoDTO> listaAsiento) {
        this.origen = origen;
    ...
    public CompraDTO(String origen, String destino, Double precio, String duracion, CamionDTO camion, List<AsientoBoletoDTO> listaAsiento) {
        this.origen = origen;
        this.destino = destino;
        this.precio = precio;
        this.duracion = duracion;
    ...
    public CompraDTO(UsuarioDTO usuario, Double precio, List<AsientoBoletoDTO> listaAsiento, ViajeDTO viaje) {
        this.usuario = usuario;
        this.precio = precio;
        this.listaAsiento = listaAsiento;
        this.viaje = viaje;
